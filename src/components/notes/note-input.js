class notesInput extends HTMLElement {
  ...
  .form-title input, .form-desc textarea {
        margin-bottom: 10px;
        width: calc(95% - 20px); /* Menyesuaikan lebar dengan memperhitungkan padding */
        padding: 10px;
                ...
                <form action="" class="form" id="form">
                    <div class="form-group">
                        ...
                        <div class="form-desc">
                            ...
                            <textarea name="description" id="description" cols="30" rows="10" placeholder="Tuliskan catatanmu disini..." required></textarea>
                        </div>
